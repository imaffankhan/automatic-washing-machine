# 1 "../Source files/digital_keypad.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../Source files/digital_keypad.c" 2
...
unsigned char read_digital_keypad(unsigned char mode)
{
    ...
    if(key!=0x3F && once){
        ...
        longpressed++;
    else if(!once && longpressed == 16 && key == 0x37){
        longpressed++;
        return 0x99;
    }
