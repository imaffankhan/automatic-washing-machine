...
# 1 "../Header files/main.h" 1
# 11 "../Header files/main.h"
...
# 12 "../Header files/main.h" 2
# 1 "../Header files/washing_machine_function_def.h" 1
# 11 "../Header files/washing_machine_function_def.h"
...
# 13 "../Header files/main.h" 2
# 1 "../Header files/clcd.h" 1
# 35 "../Header files/clcd.h"
void init_clcd(void);
void clcd_putch(const char data, unsigned char addr);
void clcd_print(const char *str, unsigned char addr);
void clcd_write(unsigned char byte, unsigned char mode);
# 14 "../Header files/main.h" 2
# 1 "../Header files/digital_keypad.h" 1
# 32 "../Header files/digital_keypad.h"
unsigned char read_digital_keypad(unsigned char mode);
void init_digital_keypad(void);
# 15 "../Header files/main.h" 2
# 1 "../Header files/timers.h" 1
# 11 "../Header files/timers.h"
void init_timer2(void);
# 16 "../Header files/main.h" 2
# 10 "../Source files/main.c" 2
#pragma config WDTE = OFF

unsigned int operational_state=0x01;
unsigned int reset_flag=0x11;
...
void main(void) {
    init_config();
    unsigned char key;
    clcd_print("Press key 5 to",(0x80 + 1));
    clcd_print("Power ON",(0xC0 + 5));
    clcd_print("Washing Machine",(0x90 + 1));
    while(read_digital_keypad(0) != 0x2F){
    ...
    while(1){
        ...
        for(unsigned int delay=3000;delay--;);
        if(key == 0x99 && (operational_state ==0x01)){
            operational_state = 0x02;
            reset_flag=0x22;
        }
        else if((key == 0x99) && (operational_state == 0x02)){
            operational_state = 0x03;
            clear_clcd();
            clcd_print("press switch",(0x80 + 0));
            clcd_print("SW5: START",(0xC0 + 0));
            clcd_print("SW6: STOP",(0x90 + 0));
            set_time();
        }
        else if(key == 0x2F && operational_state == 0x44){
            operational_state = 0x04;
            TMR2ON = 1;
            RC2 = 1;
        }
